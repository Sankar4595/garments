...
const BuyPack = () => {
  ...
  const handleAddToCart = () => {
    if (!cartState.cartArray.find((item) => item._id === "43")) {
      addToCart(
        productState.products.find((item) => item.id === "43") as ProductType
      );
      updateCart("43", 1, "", "");
    }

    if (!cartState.cartArray.find((item) => item._id === "44")) {
      addToCart(
        productState.products.find((item) => item.id === "44") as ProductType
      );
      updateCart("44", 1, "", "");
    }

    if (!cartState.cartArray.find((item) => item._id === "42")) {
      addToCart(
        productState.products.find((item) => item.id === "42") as ProductType
      );
      updateCart("42", 1, "", "");
    }
